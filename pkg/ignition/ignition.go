...
func GetIgnitionSource(vmi *v1.VirtualMachineInstance) *v1.Ignition {
	precond.MustNotBeNil(vmi)
	return vmi.Spec.Domain.Ignition
}
...
func GenerateIgnitionLocalData(vmi *v1.VirtualMachineInstance, namespace string) error {
	...
	precond.MustNotBeNil(vmi.Spec.Domain.Ignition)
	...
	ignitionData := []byte(vmi.Spec.Domain.Ignition.Data)
